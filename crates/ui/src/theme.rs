...
impl Theme {
    pub fn light() -> Self {
        Theme {
            ...
            yellow: rgb(0xedbb00),
            syn_keyword: rgb(0x9b2c6f),
            syn_string: rgb(0x1f7a4f),
            syn_comment: rgb(0x8a8580),
            syn_number: rgb(0xa05a00),
            syn_function: rgb(0x0d5e8a),
            syn_type: rgb(0x6b3fa0),
            syn_attr: rgb(0x0088b0),
    ...
    pub fn dark() -> Self {
        Theme {
            ...
            yellow: rgb(0xedbb00),
            syn_keyword: rgb(0xf28cc2),
            syn_string: rgb(0x8fd4a8),
            syn_comment: rgb(0x8e8883),
            syn_number: rgb(0xf0b45a),
            syn_function: rgb(0x7cc4ea),
            syn_type: rgb(0xc8a9f0),
            syn_attr: rgb(0x5dc2e8),
